...
import doneRecipesMockData from './helpers/mocks/doneRecipesMockData';
...
describe('Testa a página Done Recipes', () => {
  ...
  test('Verifica se a existe uma comida na tela de receitas feitas', () => {
  ...
  test('Verifica se a existe uma bebida na tela de receitas feitas', () => {
    renderWithRouterAndContext(<App />, [url]);
  ...
  test('Verifica se é possível apagar os filtros', () => {
    renderWithRouterAndContext(<App />, [url]);
