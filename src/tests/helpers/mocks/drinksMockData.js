...
const collinGlass = 'Collin Glass';
const cocktailGlass = 'Cocktail glass';
const grandMarnier = 'Grand Marnier';
const shotGlass = 'Shot glass';
const baileysIrishIceCream = 'Baileys irish cream';
const coffeTea = 'Coffe / Tea';

const drinksMockData = {
  drinks: [
    {
      idDrink: '15997',
      strDrink: 'GG',
    ...
    },
    {
      ...
      strIngredient2: baileysIrishIceCream,
    ...
    },
    {
      ...
      strIngredient1: baileysIrishIceCream,
      strIngredient2: grandMarnier,
